...
library(dplyr); library(lattice); library(reshape2)
```
...
The mean number of steps taken daily for the new dataset is **`r newmeansteps`**, compared with the orginal mean of **`r meansteps`**.  

The median number of steps taken daily for the new dataset is **`r newmediansteps`**, compared with the orginal median of **`r mediansteps`**.  
